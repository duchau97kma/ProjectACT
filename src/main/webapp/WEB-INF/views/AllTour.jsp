...
<div class="site-blocks-cover inner-page-cover" style="background-image: url(AdminTemplate/images/bgslVN.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
    <div class="container">
        <div class="row align-items-center justify-content-center text-center">

            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
                <h1 class="text-white font-weight-light">Các Tour trong và ngoài nước</h1>
                <div><a href="/">Home</a> <span class="mx-2 text-white">&bullet;</span> <span class="text-white">Tất cả các Tour</span></div>
...
<script>
    $(document).ready(function () {
        function createCard(items) {
            ...
            let totalMember =items.totalMember;
            let price=items.price-(items.price*items.discount);
            return ' <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">\n' +
                ...
                '                            <h3>'+ nameTour+'</h3>\n' +
                '                            <span>'+ date+'</span> <br>\n' +
                '                            <span class="price" style="text-decoration: line-through">$ '+ priceTour+'</span> <span class="price" style="color: red">$ '+price+'</span> <br>\n' +
                '                            <span class="price">Số người: '+ totalMember+'</span>\n' +
                '                        </div>\n' +
                '                    </a>\n' +
                '                </div>';
        }
        let page = 2;
        let total=0;
        $.get('/getAllTour/total',function (count) {
            total=count;
        })
        $('#loadmore').click(function () {

           $.get('/getAllTour?page='+page,function (data) {
               if((page-1)==total)
                   $('#loadmore').hide();
               const content =  $('.row')[2];

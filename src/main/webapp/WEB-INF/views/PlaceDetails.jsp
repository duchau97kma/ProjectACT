    ...
    <div class="container">
        <div class="row align-items-center bg-light">
            <div class="col-md-6 mb-5 mb-md-0">
                <img src="/uploadImg/${detailsPlace.images.nameImages}" alt="Image" class="img-fluid rounded">
            </div>
            <div class="col-md-6 pl-md-5 ">
                <h2 class="font-weight-light text-black mb-4">${detailsPlace.namePlace}</h2>
                <h5>${detailsPlace.summary}</h5>
                <br>
            </div>
        </div>
    </div>
...
<div class="site-section">
    <div class="container-fluid" style="padding-right: 100px;padding-left:100px;">
        <div class="row justify-content-center mb-5" data-aos="fade-up">
            <div class="col-md-7">
                <h2 class="font-weight-light text-black text-center">Danh sách các Tour</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-9">
                <div class="p-5 bg-light" data-aos="fade-up">
                    <div class="row">
...
<%--                    <c:forEach var="items" items="${tour}">--%>
<%--                        <a href="TourDetails?id=${items.id_tour}"><h1>${items.nameTour}</h1></a>--%>
<%--                    </c:forEach>--%>
                </div>
            ...
            <div class="col-md-3">
                <div class="p-1 mb-3 bg-light">
                    <h3 class="mb-0 font-weight-normal bg-primary" style="color: #f1f1f1">Danh mục</h3>
                    <h5 class="m-lg-3"><a href="/AllTourVN"><span class="icon-plane"></span>  Du lịch trong nước</a></h5>
                    <h5 class="m-lg-3"><a href="/AllTourInt "><span class="icon-plane"></span>  Du lịch nước ngoài</a></h5>
...
<%--<h1>${detailsPlace.namePlace}</h1>--%>
<%--<c:forEach var="items" items="${tour}">--%>
<%--<h1>${items.nameTour}</h1>--%>
<%--</c:forEach>--%>
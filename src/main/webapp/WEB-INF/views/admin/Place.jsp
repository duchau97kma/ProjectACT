            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8 col-md-offset-2">
                        <h3 class="header smaller lighter blue">ALL Category</h3>
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            ...
                            <c:forEach var="items" items="${place}">
                                <tr>
                                    ...
                                    <td>${items.id_place}</td>
                                    <td><a href="">${items.namePlace}</a></td>
                                    <td><img width="150" height="150" alt="150x150" src="/uploadImg/${items.images.nameImages}" /><td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a class="green" href="EditPlace?id=${items.id_place}">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>

                                            <a class="red" href="DeletePlace?id=${items.id_place}" onclick="return confirm('Delete this item?')">

    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">ADD Place</h3>
                        <spring:form class="form-horizontal" role="form" action="savePlace" method="POST">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Name </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" placeholder="Place Name" name="namePlace" class="col-xs-10 col-sm-5" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea rows="10" cols="119" name="summary"></textarea>
                                </div>
                            </div>
                            <div class="form-group">

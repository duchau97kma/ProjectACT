            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <%--@elvariable id="myFile" type="Controller"--%>
                    ...
                    <!-- /.col -->
                    <c:forEach var="items" items="${file}">
                        <div class="col-xs-4 col-sm-3">
                                <img width="300" height="300" alt="150x150" src="/uploadImg/${items.nameImages}" />
                            <br>
                            <br>
                            <a href="imageDetails?id=${items.id_img}"><button class="btn btn-info">Info</button></a> <a
                                href="deleteImage?id=${items.id_img}" onclick="return confirm('Delete this item?')"><button class="btn btn-danger">Delete</button></a>
                        </div>
                    </c:forEach>
                </div><!-- /.row -->
            </div><!-- /.page-content -->

            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8 col-md-offset-2">
                        <h3 class="header smaller lighter blue">ALL Contact</h3>
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <c:forEach var="items" items="${contact}">
                                <tr>
                                    <td class="center">
                                        <label class="pos-rel">
                                            <input type="checkbox" class="ace" />
                                    ...
                                    <td>${items.member.fullname} </td>
                                    <td>${items.content}</td>
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">


                                            <a class="red" href="deleteContact?id=${items.id_contact}" onclick="return confirm('Delete this item?')">

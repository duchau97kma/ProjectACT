            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <spring:form class="form-horizontal" role="form" action="updateCate" method="POST">
                            <input type="hidden" name="id_cate" value="${cate.id_cate}">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Name </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" value="${cate.nameCate}" name="nameCate" class="col-xs-10 col-sm-5" />

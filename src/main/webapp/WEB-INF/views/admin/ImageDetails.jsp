    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">IMAGES DETAILS</h3>
                        <br>
                    </div>
                    <spring:form class="form-horizontal" role="form" action="#" method="POST">
                    <div class="col-xs-6 col-md-offset-1">
                        <img width="600" height="450" alt="150x150" src="/uploadImg/${img.nameImages}" />
                    </div>
                    <div class="col-xs-4 ">
                        <h3><i>ID:</i> ${img.id_img}</h3>
                        <h3><i>Name:</i> ${img.nameImages}</h3>
                        <h3><i>Total Size:</i> ${img.size}</h3>
                        <h3><i>Create At:</i> ${img.create_at}</h3>

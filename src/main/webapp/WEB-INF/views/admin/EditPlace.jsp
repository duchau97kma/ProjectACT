    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">Edit Place</h3>
                        <spring:form class="form-horizontal" role="form" action="updatePlace" method="POST">
                            <input type="text" name="id_place" value="${place.id_place}">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Name Place </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" value="${place.namePlace}" name="namePlace" class="col-xs-10 col-sm-5" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea rows="10" cols="119" name="summary">${place.summary}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <input type="text" id="images" placeholder="Select Name" name="id_img" value="${place.images.nameImages}" class="col-xs-3 col-sm-5" />
                                                </div>

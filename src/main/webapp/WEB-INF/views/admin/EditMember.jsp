    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">EDIT MEMBER</h3>
                        <spring:form class="form-horizontal" role="form" action="updateMember" method="POST" modelAttribute="mem">
                            <input type="text" name="id_member" value="${mem.id_member}">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Account </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" value="${mem.account}" name="account" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" value="${mem.password}" name="password" class="col-xs-10 col-sm-5" />

                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Fullname </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" value="${mem.fullname}" name="fullname" class="col-xs-10 col-sm-5" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" value="${mem.phone}" name="phone" class="col-xs-10 col-sm-5" />

                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Permission </label>
                                <div class="col-sm-9">

                                    <select name="permission">
                                        <option value="${mem.permission}">${mem.permission}</option>

    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">ADD MEMBER</h3>
                        <spring:form class="form-horizontal" role="form" action="saveMember" method="POST" modelAttribute="addMember">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Account </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" placeholder="Account" name="account" class="col-xs-10 col-sm-5" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" placeholder="Fullname" name="fullname" class="col-xs-10 col-sm-5" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" placeholder="Phone" name="phone" class="col-xs-10 col-sm-5" />

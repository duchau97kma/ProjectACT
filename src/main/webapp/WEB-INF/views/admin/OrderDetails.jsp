            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8 col-md-offset-2">
                        <h3 class="header smaller lighter blue">ALL Order</h3>
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            ...
                            <c:forEach var="items" items="${orderDetails}">
                                <tr>
                                    ...
                                    <td>${items.order.id_order}</td>
                                    <td>${items.tour.nameTour}
                                    </td>
                                    <td>${items.totalPrice}
                                    </td>
                                    <td>${items.totalUser}</td>
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            ...
                                            <a class="red" href="deleteOrderDetails?id=${items.order.id_order}" onclick="return confirm('Delete this item?')">

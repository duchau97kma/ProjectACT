    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">ADD TOUR</h3>
                        <spring:form class="form-horizontal" role="form" action="saveTour" method="POST">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Name </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" placeholder="Tour Name" name="nameTour" class="col-xs-10 col-sm-5" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" placeholder="Total Member" name="totalMember" class="col-xs-10 col-sm-5" />
...
<%--                                        <option value="2">2-User</option>--%>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <input type="text" id="images" placeholder="Select Name" name="id_img" class="col-xs-3 col-sm-5" />
                                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" placeholder="Price" name="price" class="col-xs-10 col-sm-5" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" placeholder="Discount" name="discount" class="col-xs-10 col-sm-5" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" id="form-field-1" name="departureDate" class="col-xs-10 col-sm-5" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea rows="10" cols="119" name="summaryTour"></textarea>
                                </div>
                            </div>
                            <div class="form-group">

    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">ALL MEMBER</h3>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        ...
                                        <a class="green" href="EditMember?id=${items.id_member}">
                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                        </a>

                                        <a class="red" href="deleteMember?id=${items.id_member}" onclick="return confirm('Delete this item?')">

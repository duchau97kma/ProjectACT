        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 mb-5">
                    ...
                    <form action="auth" method="post" class="p-5 bg-white">
                        <p style="color: blue">${success}</p>
                        <p style="color: red">${fail}</p>
                        <div class="row form-group">
                            <div class="col-md-6 mb-3 mb-md-0">
                                <label class="text-black" for="fname">Account</label>
                                <input type="text" id="fname" name="account" class="form-control" placeholder="Account">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6 mb-3 mb-md-0">
                                <label class="text-black" for="lname">Full name</label>

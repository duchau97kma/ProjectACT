...
<div class="site-blocks-cover inner-page-cover" style="background-image: url(AdminTemplate/images/intertour.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
    <div class="container">
        <div class="row align-items-center justify-content-center text-center">

            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
                <h1 class="text-white font-weight-light">Các Tour quốc tế</h1>
                <div><a href="/">Home</a> <span class="mx-2 text-white">&bullet;</span> <span class="text-white">Tất cả các Tour quốc tế</span></div>
...
<script>
    $(document).ready(function () {
        ...
        let page = 2;
        let total= 0;
        $.get('/getAllTourInt/total',function (count) {
            total=count;
        })
        $('#loadmore').click(function () {

            $.get('/getAllTourInt?page='+page,function (data) {
                if((page-1)==total)
                    $('#loadmore').hide();
                const content =  $('.row')[2];

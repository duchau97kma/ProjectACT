        ...
        <div class="row">
            <div class="col-md-7 mb-5">
                <div class="p-4 mb-3 bg-white">
                    <h3 style="color: blue">Xin cảm ơn! Chúng tôi sẽ sớm liên hệ lại với bạn</h3>
                    <p style="color: #9c3328"> Tiếp tục khám phá thêm nhiều Tour hấp dẫn khác -> <a href="/AllTour" class="btn btn-primary py-2 px-4 text-white">Khám phá</a></p>
                </div>

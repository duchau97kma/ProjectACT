...
<div class="site-blocks-cover inner-page-cover" style="background-image: url(AdminTemplate/images/singapore.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
    <div class="container">
        <div class="row align-items-center justify-content-center text-center">

            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
                <h1 class="text-white font-weight-light">Địa điểm trong và ngoài nước</h1>
                <div><a href="/">Home</a> <span class="mx-2 text-white">&bullet;</span> <span class="text-white">Tất cả địa điểm</span></div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 text-center mt-5 mb-5">
                <%--                    <a href="#" class="btn btn-outline-primary border-2 py-3 px-5">Load more</a>--%>
        ...
        <div class="nonloop-block-13 owl-carousel">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 mb-5">
                            <img src="AdminTemplate/images/img_1.jpg" alt="Image" class="img-md-fluid">
                        </div>
            ...
            <div class="item">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 mb-5">
                            <img src="AdminTemplate/images/img_2.jpg" alt="Image" class="img-md-fluid">
                        </div>
                        <div class="overlap-left col-lg-6 bg-white p-md-5 align-self-center">
                            <p class="text-black lead">&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique dolorem quisquam laudantium, incidunt id laborum, tempora aliquid labore minus. Nemo maxime, veniam! Fugiat odio nam eveniet ipsam atque, corrupti porro&rdquo;</p>
            ...
            <div class="item">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 mb-5">
                            <img src="AdminTemplate/images/img_4.jpg" alt="Image" class="img-md-fluid">
                        </div>
                        <div class="overlap-left col-lg-6 bg-white p-md-5 align-self-center">
                            <p class="text-black lead">&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique dolorem quisquam laudantium, incidunt id laborum, tempora aliquid labore minus. Nemo maxime, veniam! Fugiat odio nam eveniet ipsam atque, corrupti porro&rdquo;</p>
                            <p class="">&mdash; <em>James Martin</em>, <a href="#">Traveler</a></p>
...
<script>
    $(document).ready(function () {
        function createCard(place) {
            let id= place.id_place;
            let image = place.images.nameImages
            let namePlace = place.namePlace
            return '<div class="col-md-6 col-lg-4 mb-4 mb-lg-4">\n' +
                '                    <a href="PlaceDetails?id='+id+'" class="unit-1 text-center">\n' +
                '                        <img src="../../../uploadImg/'+image+'" alt="Image" class="img-fluid">\n' +
                '                        <div class="unit-1-text">\n' +
                '                            <strong class="text-primary mb-2 d-block"></strong>\n' +
                '                            <h3 class="unit-1-heading">'+namePlace+'</h3>\n' +
                '                        </div>\n' +
                '                    </a>\n' +
                '                </div>';
        }
        let page = 2;
        let total=0;
        $.get('/getAllPlace/total',function (count) {
            total=count;
        })
        $('#loadmore').click(function () {

            $.get('/getAllPlace?page='+page,function (data) {
                if((page-1)==total)
                    $('#loadmore').hide();
                const content =  $('.row')[2];
